...
| `jupyterhub.proxy.secretSync.image.tag` |  | `"1.2.0"` |
...
| `jupyterhub.singleuser.networkTools.image.tag` |  | `"1.2.0"` |
...
| `jupyterhub.prePuller.hook.image.tag` |  | `"1.2.0"` |
